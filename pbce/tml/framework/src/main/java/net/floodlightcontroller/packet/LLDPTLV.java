...
public class LLDPTLV {
  ...
  public byte[] serialize() {
    ...
    bb.putShort(scratch);
    if (this.value != null) bb.put(this.value);
    return data;
  }
  ...
  public LLDPTLV deserialize(ByteBuffer bb) {
    ...
    if (this.length > 0) {
      ...
      if (bb.remaining() < this.length) return null;
      bb.get(this.value);
    }
    return this;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof LLDPTLV)) return false;
  ...
  public String toString() {
    String str =
        "type="
            ...
            + this.length
            + " value=";
    for (byte b : this.value) str += Integer.toString(b, 16).toUpperCase();
    return str;
  }
}
