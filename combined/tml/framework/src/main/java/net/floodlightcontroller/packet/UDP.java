...
public class UDP extends BasePacket {
  ...
  public byte[] serialize() {
    ...
    if (this.checksum == 0) {
      ...
      if (this.parent != null && this.parent instanceof IPv4) {
        ...
        accumulation +=
            ((ipv4.getSourceAddress().getInt() >> 16) & 0xffff)
                + (ipv4.getSourceAddress().getInt() & 0xffff);
        accumulation +=
            ((ipv4.getDestinationAddress().getInt() >> 16) & 0xffff)
  ...
  public boolean equals(Object obj) {
    ...
    if (!destinationPort.equals(other.destinationPort)) return false;
  ...
  public IPacket deserialize(byte[] data, int offset, int length) throws PacketParsingException {
    ...
    this.sourcePort =
        TransportPort.of((int) (bb.getShort() & 0xffff)); // short will be signed, pos or neg
    this.destinationPort =
        TransportPort.of(
            (int) (bb.getShort() & 0xffff)); // convert range 0 to 65534, not -32768 to 32767
